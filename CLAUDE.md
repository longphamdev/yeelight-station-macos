...
This project is indexed by GitNexus as **yeelight-station-macos** (99 symbols, 98 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
